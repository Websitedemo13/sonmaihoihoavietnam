...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Inner Circle · Vũ Gia" },
      {
        name: "description",
        content:
          "An invitation, by appointment only. Reach the Maison Vũ Gia private office.",
      },
      { property: "og:title", content: "Inner Circle · Vũ Gia" },
      {
        property: "og:description",
        content: "Request entry to the Maison Vũ Gia private archive.",
      },
    ],
  }),
      ...
      <main className="relative pt-40">
        <section className="px-6 pb-32 text-center">
          ...
          <h1 className="font-display mx-auto mt-8 max-w-[14ch] text-5xl uppercase leading-[0.95] text-champagne md:text-7xl lg:text-[6rem]">
            The <span className="italic text-shimmer">Inner Circle</span>
          </h1>
          <p className="mx-auto mt-12 max-w-[44ch] text-xs leading-loose tracking-[0.15em] text-champagne/55">
            We do not advertise. We do not catalogue. We answer, in writing, to
            those who ask. Leave your signature below.
          </p>
        </section>
          ...
          <div className="relative border-t border-champagne/15 bg-pitch px-6 py-20 md:px-16 lg:border-r lg:py-32">
            <div className="mx-auto max-w-md">
              ...
              <h2 className="font-display mt-6 text-3xl uppercase leading-[1.1] text-champagne md:text-4xl">
                Leave your <span className="italic text-champagne/60">mark</span>
              </h2>

              <form onSubmit={handleSubmit} className="mt-16 space-y-10">
                {[
                  { label: "Name", id: "name", type: "text" },
                  { label: "Maison / Affiliation", id: "house", type: "text" },
                  { label: "Correspondence", id: "email", type: "email" },
                ].map((f) => (
              ...
              {sealed && (
                ...
                >
                  Your seal is received. We answer in days, not minutes.
                </p>
              )}
            </div>
          </div>
            ...
            <div className="mx-auto max-w-md">
              ...
              <div className="mt-16 grid grid-cols-2 gap-10 text-xs tracking-[0.12em] text-champagne/55">
                <div>
                  ...
                  <p className="mt-2">28 Phố Hàng Khay</p>
                </div>
                <div>
                  <p className="font-sans text-[9px] tracking-eyebrow uppercase text-champagne/40">
                    Galerie
                  ...
                  <p className="mt-2">14 Rue de Sévigné · 4ᵉ</p>
                </div>
              </div>
            </div>
          </div>
